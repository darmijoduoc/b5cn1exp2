...
public class ScheduleConsumer {
    ...
    @RabbitListener(queues = RabbitMQConfig.SCHEDULE_QUEUE, ackMode = "MANUAL")
    public void handleScheduleMessage(
        ...
        try {
            log.info(
                "Actualización de horario recibida: ID={}, Vehículo={}, Tipo={}",
            ...
            log.info(
                "Archivo JSON creado para actualización: {}",
                scheduleUpdate.getUpdateId()
            );
            ...
            log.info(
                "Actualización de horario procesada exitosamente: {} (ACK enviado)",
                scheduleUpdate.getUpdateId()
            );
        } catch (Exception e) {
            log.error(
                "Error al procesar mensaje de horario para ID: {}",
                scheduleUpdate.getUpdateId(),
                e
            );
            try {
