...
# Script de ejecución local para Producer GPS
# Puerto: 8082
...
clear
echo -e "${BLUE}╔════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║   Producer GPS - Ejecución Local          ║${NC}"
echo -e "${BLUE}║   Puerto: 8082                             ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════╝${NC}"
echo ""
...
echo -e "${BLUE}════════════════════════════════════════════${NC}"
echo -e "${GREEN}🚀 Iniciando Producer GPS...${NC}"
echo -e "${BLUE}════════════════════════════════════════════${NC}"
echo ""
echo -e "${YELLOW}Endpoints disponibles:${NC}"
echo "  • POST http://localhost:8082/api/producer/gps/location"
echo "  • POST http://localhost:8082/api/producer/gps/locations/batch"
echo "  • GET  http://localhost:8082/api/producer/gps/health"
echo ""
